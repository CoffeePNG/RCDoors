...
import nl.pim16aap2.animatedarchitecture.spigot.v26_2.SubPlatform_V26_2;
...
public abstract class SpigotSubPlatformModule
{
    ...
    static ISpigotSubPlatform getSubPlatform(
        ...
        Provider<SubPlatform_V26_2> subPlatform_v26_2)
    {
        ...
        if (serverVersion.getMajor() >= 26)
            return subPlatform_v26_2.get();
