/**
 * The RCDoors Spigot core module contains classes and interfaces specific to the Spigot platform. It retains the
 * upstream AnimatedArchitecture API names for binary and source compatibility.
 * <p>
 ...
 *         (AnimatedArchitecturePlugin) Bukkit.getPluginManager().getPlugin("RCDoors");
 ...
 * for debugging purposes, as it allows RCDoors to see which plugins have accessed the platform.
 * <p>
